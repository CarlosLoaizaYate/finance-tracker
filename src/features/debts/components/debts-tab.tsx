...
// The bank's own statements ("No. de Cuota que se Cancela", cross-checked
// against "No. Cuotas Pdtes. Pago Total": 180 - 98 = 82) number our
...
// folder). Verified against the client's own bank transfer history (the
// $769,767 transfer landing on Jul 16 is cuota #82, not #81). Every cuota
// number we display is offset by this fixed amount so it matches the
// bank's numbering instead of just counting our own rows.
